...
sample_sentence = ["Female  Indian  Middle Aged  Flushed Face  Round Jaw  Pointy Nose  Arched Eyebrows  High Cheekbones  Oval Face"] * int(sample_size/ni) + \
                  ["Brown Eyes  Youth Male  Oval Face  No Beard  No Eyewear  White  Sideburns  Chubby"] * int(sample_size/ni) + \
                  ["White  Pale Skin  Wearing Lipstick  Female  Round Face  Blond Hair"] * int(sample_size/ni) + \
                  ["Youth  Female  Wearing Lipstick  Mouth Slightly Open  Fully Visible Forehead  High Cheekbones  Pointy Nose"] * int(sample_size/ni) + \
                  ["Attractive Man  5 o' Clock Shadow  Oval Face  Brown Hair  Eyeglasses"] * int(sample_size/ni) + \
                  ["Black  Female  Middle Aged  Big Lips  Pointy Nose  Square Face"] * int(sample_size/ni) + \
                  ["Indian  Gray Hair  Big Nose  Sunglasses  Mustache  Male"] * int(sample_size/ni) +\
                  ["Asian  Female  Narrow Eyes  Pointy Nose  Oval Face  Pale Skin  Rosy Cheeks"] * int(sample_size/ni)
